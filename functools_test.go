...
func TestMap(t *testing.T) {
	{
		res := Map(strconv.Itoa, []int{1, 2, 3})
		require.Equal(t, []string{"1", "2", "3"}, res)
	}

	{
		res := Map(strconv.Itoa, []int{})
...
func TestFilter(t *testing.T) {
	{
		res := Filter(func(a int) bool { return a > 2 }, []int{1, 2, 3, 4, 5})
		require.Equal(t, []int{3, 4, 5}, res)
	}

	{
		res := Filter(func(a int) bool { return a > 2 }, []int{})
		require.Equal(t, []int{}, res)
	}
}
...
func TestAll(t *testing.T) {
	{
		res := All(Lt(1), []int{2, 3, 4, 5, 6})
		require.True(t, res)
	}

	{
		res := All(Lt(1), []int{2, 3, 4, 1, 5, 6})
		require.False(t, res)
	}
}
...
func TestAny(t *testing.T) {
	{
		res := Any(GtEq(1), []int{2, 3, 4, 5, 6})
		require.False(t, res)
	}

	{
		res := Any(GtEq(1), []int{2, 3, 4, 1, 5, 6})
		require.True(t, res)
	}
}
...
func TestMinMax(t *testing.T) {
	{
		res := Maximum([]int{1, 2, 3, 4, 5})
		require.Equal(t, 5, res)
	}

	{
		res := Minimum([]int{1, 2, 3, 4, 5})
